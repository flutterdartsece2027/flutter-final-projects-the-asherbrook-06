    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: StreamBuilder<List<Chat>>(
          stream: _chatController.getChatsOverviewStream(currentUserId, true, false),
    ...
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            hasChats ? "No groups found" : "It's a bit lonely in here",
            style: Theme.of(context).textTheme.headlineSmall,
          ),
          const SizedBox(height: 4),
          Text(
            hasChats ? "Try a different name or email" : "Create a group to get started",
